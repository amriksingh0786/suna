...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Incentiv Atlas AI',
    description: 'Replay this Agent conversation on Incentiv Atlas AI',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Incentiv Atlas AI';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Incentiv Atlas AI';
