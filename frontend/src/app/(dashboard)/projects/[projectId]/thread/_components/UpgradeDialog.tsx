      ...
      >
        <DialogHeader>
          <DialogTitle className="flex items-center">
            ...
            Unlock the Full Atlas AI Experience
          </DialogTitle>
          <DialogDescription>
            You're currently using Atlas AI's free tier with limited
            capabilities. Upgrade now to access our most powerful AI model.
          </DialogDescription>
        </DialogHeader>
