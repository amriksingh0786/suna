                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY Incentiv AI
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to Incentiv AI Corp (701 Tillery Street
                        Unit 12-2521 Austin, Texas 78702, United States).
                      </li>
                      <li>
                        "Site" refers to the Atlas AI website, including any
                        related features, content, or applications offered from
                        time to time by the Company.
                      </li>
                      <li>
                        "Service" refers to the Atlas AI website and all related
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Atlas AI is licensed under the Apache License, Version
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All Atlas AI logos, marks, and designations are trademarks
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Atlas AI in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Atlas AI does not collect biometric or identifying
